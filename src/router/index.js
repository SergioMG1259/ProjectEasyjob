...
const routes = [{
    ...
    },
    {
        ...
        name: 'Menu-postulant',
        component: () =>
            import ('../views/For-postulant/Menu-postulant.vue'),
        children: [{
                path: '/profile-postulant/:id',
                component: ProfilePostulant
            },
            {
                path: '/postulant/:id/project/:idp',
                component: ViewProject
            }, {
                path: '/postulant/:id/list-announcements',
                component: InitiationPostulant
            }, {
                path: '/postulant/:id/announcement-postulation/:ida',
                component: Postulation_Announcement
            }, {
                path: '/postulant/:id/list-announcements-practicing',
                component: PracticantsPostulant
            }, {
                path: '/postulant/:id/my-notifications',
                component: NotificationsPostulant
            }
        ]
    },
    {
        ...
        children: [{
            ...
            {
                path: '/my-announcements/:iduser',
                component: MyAnnouncements
            },
            {
                path: '/company/:id/announcement/:ida',
                component: ViewAnnouncement
            }, {
                path: '/company/:id/view-profile-postulant/:idp',
                component: ViewPostulantProfile
            }, {
                path: '/view-profile-postulant/project/:ida',
                component: ViewProjectPostulant
            }, {
                path: '/company/:id/search-profile-postulant',
                component: SearchPostulant
            }, {
                path: '/company/:id/my-notifications',
                component: NotificationsCompany
            }
        ]
    }
